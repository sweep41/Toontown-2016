...
class ToontownLoadingScreen:
    ...
    def __init__(self):
        ...
        self.title = DirectLabel(guiId='ToontownLoadingScreenTitle', parent=self.gui, relief=None, pos=(base.a2dRight/5, 0, 0.235), text='', textMayChange=1, text_scale=0.08, text_fg=(0, 0, 0.5, 1), text_align=TextNode.ALeft, text_font=ToontownGlobals.getSignFont())
    ...
    def begin(self, range, label, gui, tipCategory, zoneId):
        ...
        if gui:
            ...
            self.title.reparentTo(base.a2dpBottomLeft, DGG.NO_FADE_SORT_INDEX)
            ...
            self.logo.reparentTo(base.a2dpTopCenter, DGG.NO_FADE_SORT_INDEX)  # base.a2dpTopLeft
        else:
            self.title.reparentTo(base.a2dpBottomLeft, DGG.NO_FADE_SORT_INDEX)
            self.gui.reparentTo(hidden)
            self.logo.reparentTo(hidden)
        self.waitBar.reparentTo(base.a2dpBottomCenter, DGG.NO_FADE_SORT_INDEX)
