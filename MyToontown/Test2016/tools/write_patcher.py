...
parser.add_argument('--src-dir', default='build',
                    help='The directory of the Toontown 2016 build.')
...
parser.add_argument('--account-server', default='toontowninfinite.com',
                    help='The address of the Toontown 2016
 account server.')
parser.add_argument('--launcher-version', default='1.0.0.0',
                    help='The current version of the Toontown 2016 launcher.')
...
# Next, add the Toontown 2016 launcher version:
