...
LeaveToSetParentPassword = 'In order to set parent account password, the game will exit to the Toontown 2016 website.'
LeaveToSetParentPasswordYes = 'Set Password'
LeaveToSetParentPasswordNo = lCancel
LeaveToEnableChatUK = 'In order to enable chat, the game will exit to the Toontown 2016 website.'
...
FriendSecretIntro = "If you are playing Toontown 2016 with someone you know in the real world, you can become True Friends.  You can chat using the keyboard with your True Friends.  Other Toons won't understand what you're saying.\n\nYou do this by getting a True Friend Code.  Tell the True Friend Code to your friend, but not to anyone else.  When your friend types in your True Friend Code on his or her screen, you'll be True Friends in Toontown!"
...
FriendSecretDetermineSecretAccountRollover = 'A friend across the Toontown 2016 network'
...
#NEW PHRASES
 5323: 'Have you heard about the new cog type?',
 5324: 'What are Tradebots?',
 5325: 'The Cogs are up to no good again!',
 5326: "I don't like what the Cogs are planning!",
#END NEW PHRASES
