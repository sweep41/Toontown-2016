...
ReportPanelConfirmations = ('You are about to report that %s has used obscene, bigoted or sexually explicit language.',
 ...
 "You are about to report that %s has created a name that does not follow the Toontown 2016 rules.",
...
ReportPanelRemovedPlayerFriend = 'We have automatically removed %s as a Player friend so as such you will not see them as your friend in any Toontown 2016 product.'
...
SuitBigWig = 'Big Wig'
SuitVendor = 'Vendor'
SuitGoldCold = 'Gold & Cold'
SuitSilvercog = 'Silvercog'
SuitSaleSwiper = 'Sale Swiper'
SuitInterchanger = 'Interchanger'
SuitStockBroker = 'Stock Broker'
SuitMisterMagic = 'Mister Magic'
SuitSeniorExchange = 'Senior Exchange'
...
SuitVendorS = 'a Vendor'
SuitGoldColdS = 'a Gold & Cold'
SuitSilvercogS = 'a Silvercog'
SuitSaleSwiperS = 'a Sale Swiper'
SuitInterchangerS = 'an Interchanger'
SuitStockBrokerS = 'a Stock Broker'
SuitMisterMagicS = 'a Mister Magic'
SuitSeniorExchangeS = 'a Senior Exchange'
...
SuitVendorP = 'Vendors'
SuitGoldColdP = 'Gold & Colds'
SuitSilvercogP = 'Silvercogs'
SuitSaleSwiperP = 'Sale Swipers'
SuitInterchangerP = 'Interchangers'
SuitStockBrokerP = 'Stock Brokers'
SuitMisterMagicP = 'Mister Magics'
SuitSeniorExchangeP = 'Senior Exchanges'
...
SuitAttackTaunts = {'Audit': ["I believe your books don't balance.",
 ...
 'Legalese': ['You must cease and desist.',
              ...
              "The opinions expressed in this attack are not those of Toontown 2016.",
...
FriendInviterPlayerFriendInfo = 'A friend across the Toontown 2016 network'
...
LauncherStartingMessage = "Starting Toontown 2016... "
...
LauncherConnectProxyAttempt = 'Connecting to Toontown 2016: %s (proxy: %s) attempt: %s'
LauncherConnectAttempt = 'Connecting to Toontown 2016: %s attempt %s'
LauncherDownloadServerFileList = 'Updating Toontown 2016...'
LauncherCreatingDownloadDb = 'Updating Toontown 2016...'
LauncherDownloadClientFileList = 'Updating Toontown 2016...'
LauncherFinishedDownloadDb = 'Updating Toontown 2016... '
LauncherStartingGame = 'Starting Toontown 2016...'
LauncherRecoverFiles = 'Updating Toontown 2016. Recovering files...'
LauncherCheckUpdates = 'Checking for updates for ' + LauncherProgress
LauncherVerifyPhase = 'Updating Toontown 2016...'
...
MusicTtiTheme = 'The Toontown 2016 Theme'
...
QuestScriptTutorialBlocker_5 = 'Very good!'
QuestScriptTutorialBlocker_6 = "Where you are going there are many Toons to talk to."
QuestScriptTutorialBlocker_7 = "If you want to chat with other Toons using the keyboard, there's another button you can use."
QuestScriptTutorialBlocker_8 = "It's called the Chat button.\x07Usually, you would need to turn on Speedchat Plus in your Account Manager on the Toontown 2016 Web site to use it.\x07But for now, it's enabled for everyone.\x07Good luck! See you later!"
...
BlockerLoadingTexts = ['Remaking Toontown into Toontown 2016',
 'Baking pie crusts',
 'Heating pie filling',
 'Loading Doodle chow',
...
TipDict = {TIP_NONE: ('',),
 TIP_GENERAL: ('Quickly check your ToonTask progress by holding down the "End" key.',
               ...
               'Press the "F9" key to take a screenshot, which will be saved in your Toontown 2016 folder on your computer.',
               ...
               'You never need to save your Toontown progress. The Toontown 2016 servers continually save all the necessary information.',
