...
class ToonBase(OTPBase.OTPBase):
    ...
    def __init__(self):
        ...
        print self.resList
        self.nativeWidth = 640   #self.nativeWidth = displayInfo.getMaximumWindowWidth()
        self.nativeHeight = 480  #self.nativeHeight = displayInfo.getMaximumWindowHeight()
        ...
        fullscreen = False #self.settings.get('fullscreen', False)
        if ('res' not in self.settings.all()) or fullscreen:
            ...
            properties.setSize(800, 600) #properties.setSize(res[0], res[1])
            properties.setTitle('Toontown 2016')
